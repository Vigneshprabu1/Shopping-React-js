...
class footer extends Component{
	...
	<div className="footer_agile_inner_info_w3l">
		<div className="col-md-3 footer-left">
			<h2><Link to="index.html"><span>E</span>lite Shoppy </Link></h2>
		...
		<p className="copy-right">&copy 2017 Elite shoppy. All rights reserved | Design by <Link to="http://w3layouts.com/">W3layouts</Link></p>
	</div>
</div>
